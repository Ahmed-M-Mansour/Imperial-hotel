  ...
  return (
    <div className="flex flex-col text-right px-2 mb-3 ">
      <div className="flex bg-aboutS px-3 py-2 rounded-xl">
        <h2 className="text-md sm:text-lg text-text1 leading-5 almarai-extrabold  w-full mx-2">
          {title}
        </h2>
        <Image src={serviceArrow} alt="About Iamge" width={15} height={15} />
      </div>
      <div className="flex justify-end py-1">
        <p className="sm:text-sm text-xs text-aboutTitle  almarai-regular pr-3 lg:w-3/4">
          {description}
        </p>
      </div>
    </div>
